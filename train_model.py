...
teams = [
    'AZ Alkmaar', 'Ajax', 'Almere City', 'Cambuur', 'Den Haag', 'Excelsior',
    'FC Emmen', 'Feyenoord', 'For Sittard', 'Go Ahead Eagles', 'Groningen',
    'Heerenveen', 'Heracles', 'NAC Breda', 'Nijmegen', 'PSV Eindhoven',
    'Sparta Rotterdam', 'Telstar', 'Twente', 'Utrecht', 'VVV Venlo',
    'Vitesse', 'Volendam', 'Waalwijk', 'Willem II', 'Zwolle'
]
...
try:
    ...
    df = pd.read_csv('football_data_dutch.csv')
    ...
    print("Error: 'football_data_dutch.csv' not found. Please make sure the file is in the same folder as this script.")
